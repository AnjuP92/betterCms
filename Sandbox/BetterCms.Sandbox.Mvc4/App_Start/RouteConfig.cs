    ...
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("Signup",
                "signup",
                new { controller = "Authentication", action = "Signup", area = "bcms-users" },
                new[] { "BetterCms.Module.Users.Controllers" });

            routes.MapRoute("Logout",
                "logout",
                new { controller = "Authentication", action = "Logout", area = "bcms-root" },
                new[] { "BetterCms.Module.Root.Controllers" });
